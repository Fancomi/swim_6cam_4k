...
# 关键点与标注预览。实时拼接走 run_6cam_4k.{ps1,sh} / run_underwater.sh。
#
# 用法:
...
#   ./scripts/run_offline.sh uw-extract          # all.fbx -> 16-plane mesh JSON
#   ./scripts/run_offline.sh uw-tex               # export per-camera first frames
#   ./scripts/run_offline.sh uw-render [BLEND_PX] # stitch (grid textures)
#   ./scripts/run_offline.sh uw-real [BLEND_PX]   # stitch (real first-frame images)
#   ./scripts/run_offline.sh uw-video DIR [BP] [S] # stitch 16 clips -> mp4
...
Examples:
  ...
  ./scripts/run_offline.sh uw-extract
  ./scripts/run_offline.sh uw-tex
  ./scripts/run_offline.sh uw-real 120
